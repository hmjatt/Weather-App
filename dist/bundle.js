            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 5:
                  ...
                  dateEle.innerText = new Date().toDateString(); //fill content with values
